...
public class ClienteController {
	...
	@Autowired
	/**
	 * @Qualifier("clienteDaoJPA") esto se pone si tenemos mas de una base
	 **/
	...
	@Secured("ROLE_USER")/*Habilitar distintos roles '{"ROLE_USER", "ROLE_ADMIN"}'*/
	...
	/*@Secured("ROLE_USER") lo sustituimos por PreAuthorize, antes habilitar en SpringSecurityConf. prePostEnabled*/
	@PreAuthorize("hasRole('ROLE_USER')")/*Habilitar distintos roles 'hasAnyRole("ROLE_USER", "ROLE_ADMIN")'*/
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
		...
		if(auth != null) {
			logger.info("Utilizando forma estática SecurityContextHolder.getContext().getAuthentication(): Hola usuario autenticado, tu user name es: ".concat(auth.getName()));
		}
		
		/* 3 Maneras para validar el código */
		...
		/* En SpringBoot 2.0 se cambia el new PageRequest por PageREquest.of() */
	...
	public String guardar(@Valid Cliente cliente, BindingResult result, Model model,
		...
		/* si contiene errores que retorne al formulario */
		if (result.hasErrors()) {
		...
		/* mensaje de aviso dependiendo si es editado o creado */
